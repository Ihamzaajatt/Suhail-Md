...
global.caption = process.env.CAPTION || global.caption || ""ᦔ𝐇𝐚𝐦𝐳𝐚_𝐉𝐮𝐭𝐭"𓆩🐼⃝❤️𓆪⁩" 
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 "ᦔ𝐇𝐚𝐦𝐳𝐚_𝐉𝐮𝐭𝐭"𓆩🐼⃝❤️𓆪⁩ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || ""ᦔ𝐇𝐚𝐦𝐳𝐚_𝐉𝐮𝐭𝐭"𓆩🐼⃝❤️𓆪⁩",
  ownername:process.env.OWNER_NAME|| ""ᦔ𝐇𝐚𝐦𝐳𝐚_𝐉𝐮𝐭𝐭"𓆩🐼⃝❤️𓆪⁩",
